...
15. **Jules AI Assistant** (Python/Legacy API): Integrates advanced AI reasoning into Burp for contextual analysis of requests/responses, logic flaw discovery, and exploit payload generation.
