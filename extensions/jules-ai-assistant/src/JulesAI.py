...
class BurpExtender(IBurpExtender, ITab, IContextMenuFactory):
    ...
    def setup_ui(self):
        ...
        # Configuration Panel
        config_panel = JPanel(GridLayout(8, 2))
        ...
        self.api_key_field = JTextField(self.logic.config.get("api_key", ""))
        config_panel.add(self.api_key_field)

        config_panel.add(JLabel("API Endpoint:"))
        self.endpoint_field = JTextField(self.logic.config.get("endpoint", "https://api.openai.com/v1/chat/completions"))
        ...
        self.source_id_field = JTextField(self.logic.config.get("source_id", ""))
        config_panel.add(self.source_id_field)

        config_panel.add(JLabel("Active Session ID:"))
        self.session_id_field = JTextField(self.logic.config.get("session_id", ""))
